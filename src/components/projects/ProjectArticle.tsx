      ...
      <div className="px-6 md:px-10">
        ...
        <div data-scrub-root className="grid grid-cols-12 gap-8 md:gap-12">
          ...
          <div className="col-span-12 md:col-span-5">
            <div
              className={
                project.slug === "crowdmind"
                  ? "md:sticky md:top-0 md:flex md:h-screen md:flex-col md:justify-center md:py-12"
                  : "md:sticky md:top-24"
              }
            >
              <div
                className="mx-auto w-full md:max-w-[var(--cover-cap,none)]"
